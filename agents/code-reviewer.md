...
## ⚙️ Reglas
1. **Verificación de Estilos y Reglas:** Auditar que el código implementado siga las reglas de `rules/common/` y las específicas de lenguaje (`rules/python/`, `rules/typescript/`).
